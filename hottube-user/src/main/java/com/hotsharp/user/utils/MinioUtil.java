package com.hotsharp.user.utils;

import com.hotsharp.user.constant.FileConstant;
...
public class MinioUtil {
     ...
     * @param file
     */
    public void uploadImage(File file, String dir) {
        String name = file.getName();
        String objectName = FileConstant.MINIO_AVATAR_PREFIX + dir + "/" + name;
        try {
